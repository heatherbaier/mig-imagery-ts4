...
def make_points(box, projection, projection_back, boxes_dir, utm_proj, wgs84):
  ...
  try:
    ...
    inital_point      = shapely.geometry.Point(top_left_point.x + 3360.0, top_left_point.y - 3360.0)
    test_point        = shapely.geometry.Point(top_left_point.x + 3360.0, top_left_point.y - 3360.0)

    # Double check that it interesects with our overall bounding box

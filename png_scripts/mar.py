...
IMAGERY_DIR = "MEXimagery/2010/3"
FULL_DIR = os.path.join(os.getcwd(), IMAGERY_DIR)
TEMP_DIR = os.path.join(os.getcwd(), "mar_temp")
dir_length = len(os.listdir(FULL_DIR))
num = 17096

for zipfolder in os.listdir(FULL_DIR)[17096:]:
    
    try:
    
        print("Image ", str(num), " of ", str(dir_length), "---- Month: March")
        num += 1
        ...
        PIL_image.save(os.path.join(os.getcwd(), "model_imagery", (image_name + "_MAR" + ".png")))

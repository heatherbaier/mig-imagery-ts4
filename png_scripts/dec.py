...
IMAGERY_DIR = "MEX2imagery/2010/12"
FULL_DIR = os.path.join(os.getcwd(), IMAGERY_DIR)
TEMP_DIR = os.path.join(os.getcwd(), "dec_temp")
...
for zipfolder in os.listdir(FULL_DIR):
    ...
    try:
        ...
        print("Image ", str(num), " of ", str(dir_length), "---- Month: December")
        num += 1
        ...
        PIL_image.save(os.path.join(os.getcwd(), "model_imagery2", (image_name + "_DEC" + ".png")))

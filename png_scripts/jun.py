...
IMAGERY_DIR = "MEXimagery/2010/6"
FULL_DIR = os.path.join(os.getcwd(), IMAGERY_DIR)
TEMP_DIR = os.path.join(os.getcwd(), "jun_temp")
dir_length = len(os.listdir(FULL_DIR))
num = 15768

for zipfolder in os.listdir(FULL_DIR)[15768:]:
    
    try:
    
        print("Image ", str(num), " of ", str(dir_length), "---- Month: June")
        num += 1
        ...
        PIL_image.save(os.path.join(os.getcwd(), "model_imagery", (image_name + "_JUN" + ".png")))

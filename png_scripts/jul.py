...
IMAGERY_DIR = "MEXimagery/2010/7"
FULL_DIR = os.path.join(os.getcwd(), IMAGERY_DIR)
TEMP_DIR = os.path.join(os.getcwd(), "jul_temp")
dir_length = len(os.listdir(FULL_DIR))
num = 0

for zipfolder in os.listdir(FULL_DIR)[0:21191]:
    
    try:
    
        print("Image ", str(num), " of ", str(dir_length), "---- Month: July")
        num += 1
        ...
        PIL_image.save(os.path.join(os.getcwd(), "model_imagery", (image_name + "_JUL" + ".png")))
